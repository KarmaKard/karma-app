    ...
    return (
      <div>
        ...
        <Tabs className='bottomTabs' initialSelectedIndex={0} style={{bottom:-4, position: 'fixed', width: '100%'}}>
          <Tab onClick={this.toDeals} style={{color: 'rgb(255, 112, 112)', boxShadow: '0 -6px 14px rgba(255, 112, 112, 0.48), 0 -2px 7px rgba(255, 112, 112, 0.56)'}} value='0' label=<i className="material-icons md-36">local_offer</i> ></Tab>
