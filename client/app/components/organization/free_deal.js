...
export default React.createClass({
  ...
  render() {
    var primaryProduct, limit, dollarValue
    if (this.props.freeDeal){
        primaryProduct = this.props.freeDeal.primaryProductName
        limit = this.props.freeDeal.limit
        dollarValue = this.props.freeDeal.dollarValue
    }
