...
export function activateInPersonPayment (donation, fundraiser, activationLink) {
  var cardAmountText
  if(donation.amount.cardAmount > 1 ){
    cardAmountText = donation.amount.cardAmount + ' Karma Kards'
  } else {
    cardAmountText = 'Karma Kard'
  }
  ...
  '<html xmlns="http://www.w3.org/1999/xhtml">'
    ...
    +'                    Thank You for donating to <strong>' + fundraiser.name + '</strong>'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block">'
    +'                    Receive your good karma by activating and/or sharing your ' + cardAmountText + ' by clicking on the button below.'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler">'
    +'                    <a href="' + activationLink + '" class="btn-primary" itemprop="url">Activate</a>'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block">'
    ...
    +'          <table width="100%">'
    +'            <tr>'
    +'              <td class="aligncenter content-block">KarmaKard</td>'
    +'            </tr>'
    +'          </table>'
    +'        </div></div>'
    +'    </td>'
...
export function activateSharedCard (user, activationLink) {
  ...
  '<html xmlns="http://www.w3.org/1999/xhtml">'
    ...
    +'                <tr>'
    +'                  <td class="content-block">'
    +'                    <strong>' + user.firstName + ' ' + user.lastName + '</strong> has shared a KarmaKard with you!'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block">'
    +'                    Receive your good karma by activating your Karma Kard by clicking on the button below.'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler">'
...
export function addFundraiserMember (fundraiserMember, fundraiser, activationLink) {
  ...
  '<html xmlns="http://www.w3.org/1999/xhtml">'
    ...
    +'                <tr>'
    +'                  <td class="content-block">'
    +'                    Hello ' + fundraiserMember.name + ','
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block">'
    +'                    <strong>' + fundraiser.name + '</strong> has added you to their fundraising team. Join the team by clicking on the button below.'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler">'
    +'                    <a href="' + activationLink + '" class="btn-primary" itemprop="url">Join Team</a>'
    +'                  </td>'
    +'                </tr>'
    +'                <tr>'
    +'                  <td class="content-block">'
