...
describe('Locations: Validate Create', function (){
  ...
  it('fails if the location is missing a orgId', () => {
    req.body = {locations: [{street: "281 E. 2950 N.", city: "Provo", state: "UT", latitude: 10.33234323243, longitude: 112.343234523345343}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
    req.validationErrors(true)['locations.0.orgId'].should.have.property('msg')
  })

  it('fails if the location is missing a street', () => {
    req.body = {locations: [{orgId: 321, city: "Provo", state: "UT", latitude: 10.33234323243, longitude: 112.343234523345343}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
  ...
  it('fails if the location is missing a city', () => {
    req.body = {locations: [{orgId: 321, street: "281 E. 2950 N.", state: "UT", latitude: 10.33234323243, longitude: 112.343234523345343}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
  ...
  it('fails if the location is missing a state', () => {
    req.body = {locations: [{orgId: 321, street: "281 E. 2950 N.", city: "Provo", latitude: 10.33234323243, longitude: 112.343234523345343}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
  ...
  it('fails if the location is missing a latitude', () => {
    req.body = {locations: [{orgId: 321, street: "281 E. 2950 N.", city: "Provo", state: "UT", longitude: 112.343234523345343}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
  ...
  it('fails if the location is missing a longitude', () => {
    req.body = {locations: [{orgId: 321, street: "281 E. 2950 N.", city: "Provo", state: "UT", latitude: 10.33234323243}]}
    validateCreate(req, res, next)
    next.getCall(0).args[0].should.be.an.instanceOf(ValidationError)
